...
def implFindAllEndConfigurations(
    ...
    currentAttempt: IntArray = np.zeros(50, dtype=np.int32) - 1
...
def findAllEndConfigurationsLoop(
    ...
    while pointers[1] >= 0:
        ...
        # leaf
            ...
            # Explicitly slice the currentAttempt to fit the targetLength
            targetLength = int(configurationParameters[1])
            endConfigurations[pointers[0], :] = currentAttempt.copy()[:targetLength]

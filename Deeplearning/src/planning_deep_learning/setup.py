...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/dl_node_global_launch.py']),
        ('share/' + package_name + '/launch', ['launch/dl_node_single_launch.py']),
        (
    ...
    entry_points={
        'console_scripts': [
            ...
            "dl_node_global = planning_deep_learning.global_node:main",
            "dl_node_single_thread = planning_deep_learning.single_thread_node:main"
        ],
    },
)

...
class KeyPoints(metaclass=Metaclass_KeyPoints):
    ...
    def __init__(self, **kwargs):
        ...
        self.keypoints = array.array('B', kwargs.get('keypoints', []))
    ...
    def keypoints(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'keypoints' array.array() must have the type code of 'B'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'keypoints' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._keypoints = array.array('B', value)

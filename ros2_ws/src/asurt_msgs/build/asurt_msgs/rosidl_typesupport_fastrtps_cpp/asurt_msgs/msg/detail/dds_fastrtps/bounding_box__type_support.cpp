...
#include "asurt_msgs/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const asurt_msgs::msg::BoundingBox & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  asurt_msgs::msg::BoundingBox & ros_message)
{
  // Member: probability
  cdr >> ros_message.probability;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = asurt_msgs::msg::BoundingBox;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const asurt_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<asurt_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  return &asurt_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, asurt_msgs, msg, BoundingBox)() {
  return &asurt_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}

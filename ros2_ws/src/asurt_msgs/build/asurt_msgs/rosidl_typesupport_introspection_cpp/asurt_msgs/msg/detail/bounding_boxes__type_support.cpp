...
{
  new (message_memory) asurt_msgs::msg::BoundingBoxes(_init);
}

void BoundingBoxes_fini_function(void * message_memory)
{
  auto typed_message = static_cast<asurt_msgs::msg::BoundingBoxes *>(message_memory);
  typed_message->~BoundingBoxes();
}

size_t size_function__BoundingBoxes__bounding_boxes(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<asurt_msgs::msg::BoundingBox> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<asurt_msgs::msg::BoundingBox> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<asurt_msgs::msg::BoundingBox> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const asurt_msgs::msg::BoundingBox *>(
    get_const_function__BoundingBoxes__bounding_boxes(untyped_member, index));
  auto & value = *reinterpret_cast<asurt_msgs::msg::BoundingBox *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<asurt_msgs::msg::BoundingBox *>(
    get_function__BoundingBoxes__bounding_boxes(untyped_member, index));
  const auto & value = *reinterpret_cast<const asurt_msgs::msg::BoundingBox *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBoxes_message_member_array[3] = {
  {
    ...
    offsetof(asurt_msgs::msg::BoundingBoxes, frame_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(asurt_msgs::msg::BoundingBoxes, object_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<asurt_msgs::msg::BoundingBox>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(asurt_msgs::msg::BoundingBoxes, bounding_boxes),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBoxes_message_members = {
  ...
  3,  // number of fields
  sizeof(asurt_msgs::msg::BoundingBoxes),
...
{
  return &::asurt_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, asurt_msgs, msg, BoundingBoxes)() {
  return &::asurt_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}

...
class PlanningDlNode(Node):
    ...
    def __init__(self, modelPath: str):
        ...
        model_file = "./src/planning_deep_learning/planning_deep_learning/best_HybridgedanconeshiftingRFIX.pth"
...
def main(args=None):
    ...
    model_file = "/perception_ws/planning_deep_learning/planning_deep_learning/best_HybridgedanconeshiftingRFIX.pth"

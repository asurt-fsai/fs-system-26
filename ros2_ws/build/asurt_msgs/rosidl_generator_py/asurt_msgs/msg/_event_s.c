...
bool asurt_msgs__msg__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("asurt_msgs.msg._event.Event", full_classname_dest, 27) == 0);
  }
  asurt_msgs__msg__Event * ros_message = _ros_message;
  {  // stamp
...
PyObject * asurt_msgs__msg__event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("asurt_msgs.msg._event");

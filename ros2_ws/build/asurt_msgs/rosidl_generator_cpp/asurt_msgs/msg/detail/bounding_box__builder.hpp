...
{
public:
  explicit Init_BoundingBox_id(::asurt_msgs::msg::BoundingBox & msg)
  : msg_(msg)
  {}
  Init_BoundingBox_type id(::asurt_msgs::msg::BoundingBox::_id_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_BoundingBox_id height(::asurt_msgs::msg::BoundingBox::_height_type arg)
  {

...
static const _NodeStatus_type_support_symbol_names_t _NodeStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, asurt_msgs, msg, NodeStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, asurt_msgs, msg, NodeStatus)),
  }
};
...
{
  return &::asurt_msgs::msg::rosidl_typesupport_cpp::NodeStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, asurt_msgs, msg, NodeStatus)() {
  return get_message_type_support_handle<asurt_msgs::msg::NodeStatus>();
}

...
#include "asurt_msgs/msg/detail/cloud_info__rosidl_typesupport_fastrtps_c.h"
...
using _CloudInfo__ros_msg_type = asurt_msgs__msg__CloudInfo;
...
size_t get_serialized_size_asurt_msgs__msg__CloudInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CloudInfo__ros_msg_type * ros_message = static_cast<const _CloudInfo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CloudInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_asurt_msgs__msg__CloudInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_asurt_msgs
size_t max_serialized_size_asurt_msgs__msg__CloudInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = asurt_msgs__msg__CloudInfo;
    is_plain =
      (
...
static size_t _CloudInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_asurt_msgs__msg__CloudInfo(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, asurt_msgs, msg, CloudInfo)() {

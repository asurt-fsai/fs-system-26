...
class PlanningDlNode(Node):
    ...
    def __init__(self, modelPath: str):
        ...
        self.subscriber1 = self.create_subscription(
            MarkerArray, "/carmaker/ObjectList", self.receiveFromPerception, 10)
    ...
    def receiveFromPerception(self, msg: MarkerArray) -> None:
        ...
        for marker in msg.markers:
            # The ObjectList from CarMaker is ALREADY in the car's local frame (Fr1A).
            # Fr1A: X is Forward, Y is Left.
    ...
    def send_to_control(self):
        ...
        if self.path is not None:
            ...
            path_msg.header.frame_id = "Fr1A" # Frame corrected to prevent TF loop errors

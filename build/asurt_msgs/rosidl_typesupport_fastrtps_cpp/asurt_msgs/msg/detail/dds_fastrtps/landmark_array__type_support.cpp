...
#include "asurt_msgs/msg/detail/landmark_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        asurt_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Landmark(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = asurt_msgs::msg::LandmarkArray;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        asurt_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Landmark(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const asurt_msgs::msg::LandmarkArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<asurt_msgs::msg::LandmarkArray *>(
    untyped_ros_message);
...
{
  return &asurt_msgs::msg::typesupport_fastrtps_cpp::_LandmarkArray__handle;
}

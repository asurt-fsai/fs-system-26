...
#ifndef ASURT_MSGS__MSG__DETAIL__KEY_POINTS__FUNCTIONS_H_
#define ASURT_MSGS__MSG__DETAIL__KEY_POINTS__FUNCTIONS_H_
 ...
 * calls
 * asurt_msgs__msg__KeyPoints__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_asurt_msgs
asurt_msgs__msg__KeyPoints *
asurt_msgs__msg__KeyPoints__create(void);

/// Destroy msg/KeyPoints message.
/**
 * It calls
 * asurt_msgs__msg__KeyPoints__fini()
 ...
 * asurt_msgs__msg__KeyPoints__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * asurt_msgs__msg__KeyPoints__Sequence__fini()
 * on the array,
...
#endif  // ASURT_MSGS__MSG__DETAIL__KEY_POINTS__FUNCTIONS_H_

...
bool asurt_msgs__msg__key_points__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("asurt_msgs.msg._key_points.KeyPoints", full_classname_dest, 36) == 0);
  }
  asurt_msgs__msg__KeyPoints * ros_message = _ros_message;
  {  // view_id
    ...
    ros_message->view_id = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // object_count
  ...
  {  // track_ids
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->track_ids.data;
  ...
  {  // keypoints
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint16_t * dest = ros_message->keypoints.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
PyObject * asurt_msgs__msg__key_points__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("asurt_msgs.msg._key_points");
  ...
  {  // view_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->view_id);
    {
  ...
  {  // track_ids
    ...
    if (ros_message->track_ids.size > 0) {
      ...
      uint8_t * src = &(ros_message->track_ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->track_ids.size * sizeof(uint8_t));
      assert(data != NULL);
  ...
  {  // keypoints
    ...
    if (ros_message->keypoints.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint16_t * src = &(ros_message->keypoints.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->keypoints.size * sizeof(uint16_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);

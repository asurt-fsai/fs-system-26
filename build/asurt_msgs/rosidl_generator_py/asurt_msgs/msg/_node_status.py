...
class Metaclass_NodeStatus(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'UNRESPONSIVE': cls.__constants['UNRESPONSIVE'],
        }

    @property
    def STARTING(self):
        """Message constant 'STARTING'."""
        return Metaclass_NodeStatus.__constants['STARTING']

    @property
    def READY(self):
        """Message constant 'READY'."""
        return Metaclass_NodeStatus.__constants['READY']
    ...
    def ERROR(self):
        ...
        return Metaclass_NodeStatus.__constants['ERROR']

    @property
    def SHUTDOWN(self):
        """Message constant 'SHUTDOWN'."""
        return Metaclass_NodeStatus.__constants['SHUTDOWN']

    @property
    def UNRESPONSIVE(self):
        """Message constant 'UNRESPONSIVE'."""
        return Metaclass_NodeStatus.__constants['UNRESPONSIVE']

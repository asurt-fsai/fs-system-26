...
#include "cloud_msgs/msg/detail/cloud_info__type_support.h"
...
static const _CloudInfo_type_support_symbol_names_t _CloudInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cloud_msgs, msg, CloudInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cloud_msgs, msg, CloudInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cloud_msgs, msg, CloudInfo)() {
  return &::cloud_msgs::msg::rosidl_typesupport_c::CloudInfo_message_type_support_handle;
}

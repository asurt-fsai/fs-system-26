...
static const _CloudInfo_type_support_symbol_names_t _CloudInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cloud_msgs, msg, CloudInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cloud_msgs, msg, CloudInfo)),
  }
};
...
{
  return &::cloud_msgs::msg::rosidl_typesupport_cpp::CloudInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cloud_msgs, msg, CloudInfo)() {
  return get_message_type_support_handle<cloud_msgs::msg::CloudInfo>();
}

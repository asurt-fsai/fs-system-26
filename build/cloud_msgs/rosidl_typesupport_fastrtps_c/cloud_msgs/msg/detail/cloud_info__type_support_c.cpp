...
bool cdr_serialize_cloud_msgs__msg__CloudInfo(
  const cloud_msgs__msg__CloudInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cloud_msgs
bool cdr_deserialize_cloud_msgs__msg__CloudInfo(
  eprosima::fastcdr::Cdr & cdr,
  cloud_msgs__msg__CloudInfo * ros_message)
{
  // Field name: header
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cloud_msgs__msg__CloudInfo;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cloud_msgs
bool cdr_serialize_key_cloud_msgs__msg__CloudInfo(
  const cloud_msgs__msg__CloudInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cloud_msgs
size_t get_serialized_size_key_cloud_msgs__msg__CloudInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CloudInfo__ros_msg_type * ros_message = static_cast<const _CloudInfo__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cloud_msgs
size_t max_serialized_size_key_cloud_msgs__msg__CloudInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cloud_msgs__msg__CloudInfo * ros_message = static_cast<const cloud_msgs__msg__CloudInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cloud_msgs__msg__CloudInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cloud_msgs__msg__CloudInfo * ros_message = static_cast<cloud_msgs__msg__CloudInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cloud_msgs__msg__CloudInfo(cdr, ros_message);
}

...
img1 = Image.open('/fsai_ws/src/supervisor/supervisor/GUI/formulaIcon.png').resize((200,100), Image.Resampling.LANCZOS)
...
img2 = Image.open('/fsai_ws/src/supervisor/supervisor/GUI/racingTeamIcon.png').resize((200,100), Image.Resampling.LANCZOS)

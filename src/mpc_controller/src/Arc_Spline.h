...
namespace mpc_controller{
    ...
    struct PathData{
        Eigen::VectorXd x;
        Eigen::VectorXd y;
        Eigen::VectorXd s; // cumulative distance along the path
    ...
    class ArcSpline{
        ...
        private:
            ...
            PathData outlierRemoval(const Eigen::VectorXd& x, const Eigen::VectorXd& y) const; // removes outlier points and returns cleaned path data

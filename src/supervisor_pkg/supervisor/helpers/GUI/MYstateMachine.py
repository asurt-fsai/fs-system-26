...
class Interface:
    ...
    def publishMissionName(self):
        ...
        try:
            ...
            return
        self._mission_timer = Timer(5.0, self.publishMissionName)
        self._mission_timer.daemon = True
    ...
    def init_ros(self):
        ...
        self.node.create_subscription(
            Bool, "/state_machine/driving_flag", self.state_machine_driving_flag_cb, 10
        )
    ...
    def state_machine_driving_flag_cb(self, msg: Bool):
    ...
    def create_widgets(self):
        ...
        self.driving_flag_button = tk.Button(
            self.master,
            text="DRIVING FLAG: OFF",
            width=24,
            height=3,
            font=("ubuntu", 12),
            bg=self.color2,

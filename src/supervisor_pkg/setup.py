...
setup(
    ...
    zip_safe=True,
    maintainer='kenzysobh',
    maintainer_email='kenzysobh@todo.todo',
    ...
    'console_scripts': [
        ...
        "communication = supervisor.helpers.CommunicationLayer:main",
        ...
        "heartbeat_simulator = supervisor.helpers.dev.heartbeat_simulator:main",

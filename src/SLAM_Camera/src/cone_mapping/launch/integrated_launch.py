...
def generate_launch_description():
    ...
    # =========================================================================
    # 4. Map to Odom Transform Publisher
    # Publishes TF: map → odom (Required to link the mapping frame to the robot)
    # =========================================================================
    ...
    # =========================================================================
    rviz_config_dir = os.path.join(source_module_path, 'config', 'integrated_default.rviz')
    ...
    # =========================================================================
    # 0. ZED Camera Launch (zed_wrapper)
    # Launches the ZED 2i camera driver
    # =========================================================================
    try:
        ...
        print(f"Warning: could not find zed_wrapper: {e}")
        zed_wrapper_launch = ExecuteProcess(cmd=['echo', 'zed_wrapper not found'])

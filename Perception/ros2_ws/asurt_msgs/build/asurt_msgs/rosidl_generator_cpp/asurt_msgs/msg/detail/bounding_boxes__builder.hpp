...
class Init_BoundingBoxes_frame_id
{
public:
  Init_BoundingBoxes_frame_id()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_BoundingBoxes_object_count frame_id(::asurt_msgs::msg::BoundingBoxes::_frame_id_type arg)
  {
...
{
  return asurt_msgs::msg::builder::Init_BoundingBoxes_frame_id();
}

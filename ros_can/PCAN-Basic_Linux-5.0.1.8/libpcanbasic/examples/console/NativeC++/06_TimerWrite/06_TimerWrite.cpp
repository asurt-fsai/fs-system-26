...
TPCANStatus TimerWrite::WriteMessageXL()
{
    // Sends a CAN-XL message with standard ID and 2047 data bytes
...
void TimerWrite::ShowConfigurationHelp()
{
    ...
    std::cout << "* TimerInterval: The time, in milliseconds, to wait before trying to write the messages  |\n";
    std::cout << "=========================================================================================\n";
    std::cout << "\n";
}
...
void TimerWrite::FormatChannelName(TPCANHandle handle, LPSTR buffer, CANProtocol protocol)
{
    BYTE byChannel;

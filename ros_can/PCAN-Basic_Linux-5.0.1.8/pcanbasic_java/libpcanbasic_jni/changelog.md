...
## [5.0.0] - 2025-08-06
### Changed
- API supports PCAN-Basic 5.0
- added support to XL entry points
- removed support of PCAN non plug and play devices

## [4.9.0] - 2024-10-01
### Updated
- Synchronized version with PCAN-Basic

## [4.8.1] - 2023-10-25
### Updated
- fixed SetValue issue with SetValue function involving MutableInteger and MutableLong buffers.
- updated PCAN_API_VERSION: if versions of PCANBasic and PCANBasic_JNI don't match, the JNI API version is concatenated to the buffer (for ex.: "4.8.0.830 (JNI=4.8.1.2)").

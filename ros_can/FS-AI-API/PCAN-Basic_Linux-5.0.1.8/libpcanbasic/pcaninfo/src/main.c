 ...
 * @file main.c
 *
 * Main entry point for the PCAN-Basic tool: 'pcaninfo'.
 * pcaninfo helps to list all PCAN devices found on the system.
 *
...
int main(int argc, char * argv[]) {
	PCANLOG_TYPE log_type = LOGTYPE_SYSLOG;
	...
	pcanlog_set(log_type, log_lvl, 0, log_lvl == LVL_DEBUG);

...
## [5.0.1] - 2026-06-26
### Changed
- a buffer of size 1 is allowed with PCAN_CHANNEL_CONDITION
- Updated PCAN sources
### Fixed
- can read and write CAN CC frames with DLC>8 (in CC, FD or XL initialization)
- reset issue (and PCAN_LISTEN_ONLY) with channel initialized with CAN XL bitrates (with pcan driver <9.2)

## [5.0.0] - 2025-09-11
### Added
- Added support to PCAN-USB_XL devices (requires PCAN Linux driver 9.0)
- Added CAN XL features (CAN_InitializeXL, CAN_ReadXL, CAN_WriteXL)

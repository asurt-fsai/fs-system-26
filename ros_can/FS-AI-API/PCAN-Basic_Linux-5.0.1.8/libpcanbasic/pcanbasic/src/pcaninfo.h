...
#define PCANINFO_FLAG_EX_FD_SSP_OFFSET	(1<<19)	/**< 'fd_ssp_offset' parameter is defined */

#define PCANINFO_FLAG_XL_BITRATE	(1<<0)		/**< 'xl_bitrate' parameter is defined */
#define PCANINFO_FLAG_XL_TSEG1		(1<<1)		/**< 'xl_tseg1' parameter is defined */
#define PCANINFO_FLAG_XL_TSEG2		(1<<2)		/**< 'xl_tseg1' parameter is defined */
#define PCANINFO_FLAG_XL_SJW		(1<<3)		/**< 'xl_sjw' parameter is defined */
#define PCANINFO_FLAG_XL_TMS		(1<<4)		/**< 'xl_tms' parameter is defined */
#define PCANINFO_FLAG_XL_TQ			(1<<5)		/**< 'xl_tms' parameter is defined */
#define PCANINFO_FLAG_XL_ES			(1<<6)		/**< 'xl_es' parameter is defined */
#define PCANINFO_FLAG_XL_SP			(1<<7)		/**< 'xl_sp' parameter is defined */
#define PCANINFO_FLAG_XL_SSP_OFFSET	(1<<8)		/**< 'xl_sp' parameter is defined */
#define PCANINFO_FLAG_XL_PWM_LONG	(1<<9)		/**< 'xl_pwml' parameter is defined */
#define PCANINFO_FLAG_XL_PWM_OFFSET	(1<<10)		/**< 'xl_pwmo' parameter is defined */
#define PCANINFO_FLAG_XL_PWM_SHORT	(1<<11)		/**< 'xl_pwms' parameter is defined */
...
struct pcaninfo {
	...
	uint32_t availflag_xl; 					/**< Each bit defines if a parameter is set (see PCANINFO_FLAG_XL_xx) */
	...
	uint32_t xl_bitrate;					/**< XL bitrate */
	uint32_t xl_es;							/**< XL Error Signaling */
	uint32_t xl_pwm_short;
	uint32_t xl_pwm_offset;
	uint32_t xl_pwm_long;
	uint32_t xl_sjw;						/**< XL SyncWidthJump */
	uint32_t xl_sp;
	uint32_t xl_ssp_offset;
	uint32_t xl_tq;
	uint32_t xl_tseg1;						/**< XL Tseg1 */
	uint32_t xl_tseg2;						/**< XL Tseg2 */
	uint32_t xl_tms;						/**< XL Transceiver Mode Switch */
};

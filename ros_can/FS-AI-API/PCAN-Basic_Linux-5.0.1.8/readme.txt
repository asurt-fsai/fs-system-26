...
System Requirements
-------------------
- PCAN Linux Driver: 9.0.0 and above (recommended version: 9.0)
...
\pcanbasic_java
    ...
    \libpcanbasic_java
        Contains the Java files to use PCAN-Basic and their corresponding JAR library.

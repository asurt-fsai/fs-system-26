...
static int pcan_isa_req_irq(struct pcandev *dev, struct pcanusr *dev_priv)
{
	int err;
...
static void pcan_isa_free_irq(struct pcandev *dev, struct pcanusr *dev_priv)
{
#ifdef DEBUG_TRACE

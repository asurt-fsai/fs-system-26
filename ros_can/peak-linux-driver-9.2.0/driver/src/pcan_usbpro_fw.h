...
#define DATA_TYPE_USB2CAN_STRUCT_BUSLOAD_RX                 0x86
...
#define DATA_TYPE_USB2CAN_STRUCT_FKT_SETGET_BUSLOAD_MSG     0x11
...
union pcan_usbpro_rec {
	...
	struct pcan_usbpro_busload_rx     busload_rx;
	...
	struct pcan_usbpro_busload        busload;
...
/* device state flags */
#define PCAN_USB_SHOULD_WAKEUP		0x00000001UL

extern int pcan_usbpro_return(struct pcandev *dev, int err);

...
{
	u64 timeout = pcan_get_now_ns() + ((u64 )delay_ms * 1000 * 1000);
...
lbl_flash_exit:
	...
	timeout = pcan_get_now_ns() + 5ULL * (1000 * 1000 * 1000);
	do {
		u8 s;
...
lbl_flash_exit:
	...
	timeout = pcan_get_now_ns() + 2ULL * (1000 * 1000 * 1000);
	do {
		u8 s;

...
int __pcan_netdev_rx(struct pcandev *dev, struct pcanxl_rxmsg *pf, u8 *d);

static inline int pcan_netdev_rx(struct pcandev *dev, struct pcanxl_rxmsg *pf)
{
	return __pcan_netdev_rx(dev, pf, pf->msg.data);
}

...
#define CANFD_USB_CLK_60MHZ		0x1
#define CANFD_USB_CLK_40MHZ		0x2
#define CANFD_USB_CLK_30MHZ		0x3
#define CANFD_USB_CLK_24MHZ		0x4
#define CANFD_USB_CLK_20MHZ		0x5
#define CANFD_USB_CLK_DEF		CANFD_USB_CLK_80MHZ
...
#define CANFD_USB_LED_FAST		0x01
#define CANFD_USB_LED_SLOW		0x02
#define CANFD_USB_LED_FIXED		0x03
#define CANFD_USB_LED_OFF		0x04
#define CANFD_USB_LED_DEF		CANFD_USB_LED_DEV
...
/* Extended usage of uCAN commands CANFD_CMD_XXX_YY_OPTION for PCAN-USB FD */
#define CANFD_USB_OPTION_CALIBRATION	0x8000
#define CANFD_USB_OPTION_DEBUG		0x4000
#define CANFD_USB_OPTION_FAST_FWD	0x2000
...
#define CANFD_USB_CMD_DEVID_SET		0x81
...
#define CANFD_USB_CMD_LOCINFO_SET	0x83
#define CANFD_USB_CMD_LOCINFO_GET	0x84
#define CANFD_USB_CMD_LOCINFO_RSP	0x85
...
#define CANFD_USB_LOCINFO_LEN		250

#define CANFD_USB_MSG_DEBUG		0x200
...
#define CANFD_USB_CMD_DEVDATA_SET	0xa0
#define CANFD_USB_CMD_DEVDATA_REQ	0xd0
#define CANFD_USB_CMD_DEVDATA_RSP	0xd1

struct __packed ucan_usb_devdata {
	__le16	opcode_channel;
	__le16	total_len;
	__le16	offset;
	__le16	id;
...
#define CANFD_USB_CMD_ANAL_VAL_REQ	0xce
#define CANFD_USB_CMD_ANAL_VAL_RSP	0xcf

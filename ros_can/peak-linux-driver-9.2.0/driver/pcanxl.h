...
#define PCANXL_SDT_TUNNEL_ETH_MAP	0x05	/* af = truncated dest MAC addr
						   vci = vlan id */
#define PCANXL_SDT_CAN_CC		0x06
#define PCANXL_SDT_CAN_FD		0x07
#define PCANXL_SDT_MULTI_PDU		0x08
#define PCANXL_SDT_ISO_TP		0x09
#define PCANXL_SDT_RESERVED_RANGE_LOW	0x0a
#define PCANXL_SDT_RESERVED_RANGE_HIGH	0xdf
#define PCANXL_SDT_MAN_RSRVD_LOW	0xe0
#define PCANXL_SDT_MAN_RSRVD_HIGH	0xfe
#define PCANXL_SDT_RESERVED		0xff
